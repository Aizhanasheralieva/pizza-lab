...
const DishesList = () => {
  ...
  return (
    <div>
      {loadingForFetchingDish || deletePizzaLoading ? (
        <ButtonSpinner />
      ) : (
        <>
          {allDishes.length === 0 ? (
            <p>There are any dishes added yet!</p>
          ) : (
            <>
              <div className="d-flex flex-row justify-content-evenly mb-4">
                ...
                <NavLink className="nav-link" to="/admin/addNewDish">
                  <button
                    className="btn btn-outline-primary shadow-lg text-black text-bold fs-4"
                    type="submit"
                  >
                    Add new Dish
                  </button>
                ...
                >
                  ...
                  <div className="d-flex justify-content-between mt-2">
                    <button
                      ...
                      type="button"
                      onClick={() => navigate(`/admin/${dish.id}/edit`)}
                    >
                      Edit
                    </button>
                    <button
                      ...
                      type="button"
                      onClick={() => deletePizzaDish(dish.id)}
                    >
                      Delete
                    </button>
                  </div>
